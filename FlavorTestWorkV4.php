...
<script src="<?php echo $actual_link;?>/omri/mwEmbed/mwEmbedLoader.php/p/1763321/sp/176332100/embedIframeJs/uiconf_id/27215712/partner_id/1763321"></script>
    ...
    kWidget.getSources({
      ...
      'callback': function(sourceSet){
        ...
        for (var i in sourceSet){
			...
			var $playerDiv = $("<div id='"+i+"'/>").addClass('players col-md-4');
